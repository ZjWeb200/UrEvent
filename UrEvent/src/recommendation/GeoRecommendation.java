...
// i.e. recommend items with categories numbers in descending order from the history table.
// if history table is empty, does not recommend anything.
public class GeoRecommendation {
  ...
  public List<Item> recommendItems(String userId, double lat, double lon) {
			...
			for (Entry<String, Integer> category : categoryList) {
				...
				for (Item item : items) {
					// make sure not recommend user's already favorite item and not recommended yet
